...
(function($) {
    ...
    var ToolbarHandler = {
        ...
        _rearrangeInvokeSimulate: null, /** Simulate the rearrange when dragging a folder item outside the rearrange mode */
         ...
         */
        _doPredefinedInitrename: function(e, obj, button) {
         ...
         */
        _doPredefinedInitrearrange: function(e, obj, button) {
            //e.nodes(false);
            var that = this;
        ...
        _dispatchEvent: function (el, type, evt) {
            if (el.dispatchEvent) {
        ...
        _createRearrangeEvent: function (type, target, options) {
            var evt;
            var e = $.extend({
                target: target,
     ...
     */
    var SearchHandler = {
        _fixRestoreContent: false,
        _restoreContent: undefined,
        _oldSelectedId: undefined,
        _searchTimeout: undefined,
        _noSearchResults: undefined,
        _treeHeadline: undefined,
        ...
        _doFixRestoreContent: function(e, isSearch) {
        ...
        _doSearch: function(e, searchField, value) {
     ...
     * The widget
     * 
     * @TODO initialize the handlers with "new" keyword
     */
    var AIOTree = {
        /**

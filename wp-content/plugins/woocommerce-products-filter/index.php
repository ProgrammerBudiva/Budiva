...
//+++
    ...
    public function woof_products($atts, $is_prediction = false)
    {
        ...
        public function woof_shortcode($atts)
        {
            ...
            if (!empty($taxonomies))
            {
                foreach ($taxonomies as $tax_key => $tax)
                {
                    ...
                    while($query->have_posts()) {
                        ...
                        var_dump(get_the_terms(get_the_ID(), $tax_key));
                        echo "<br>";
                    }
                    echo "<br><br>";
                    ...
                    if(empty($args['taxonomies'][$tax_key])) {
                        unset($args['taxonomies'][$tax_key]);
                        unset($args['taxonomies_info'][$tax_key]);
                        continue;
                    }
            ...
            $args['woof_settings'] = get_option('woof_settings', array());//pre($args);

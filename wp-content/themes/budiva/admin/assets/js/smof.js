...
jQuery(document).ready(function($) {
    ...
    $(".slide_add_button").live('click', function() {
        ...
        var big = slidesContainer.attr('data-big')=='0' ? false : true;
